...
exports.getOptionChains = function(params)
{
    //
	...
	//	expirationDay   integer	required	The day the option will expire
	...
	if (!this.getOptionChainsDescriptors)
    {
        this.getOptionChainsDescriptors = this._buildParamsDescriptor([
           "chainType", true, this._validateAsOneOf(["CALL","PUT","CALLPUT"]),
    ...
    if (validationResult.length)
        return errork(validationResult); // Validation failed
    ...
    this._run(actionDescriptor,params);
};

exports.getOptionExpireDates = function(underlier)
{
    //
    // From the etrade dev portal at
	...
	return this._run(actionDescriptor,{underlier:underlier});
};

exports.lookupProduct = function(params)
{
    //
    // From the etrade dev portal at
	...
	if (!this.lookupProductDescriptor)
    {
		this.lookupProductDescriptor = this._buildParamsDescriptor([
            ...
            "type", true, this._validateAsOneOf(["EQ","MF"])
        ]);
    }
...
exports.getQuote = function(params)
{
    //
    // From the etrade dev portal at
	...
	if (!this.getQuoteDescriptor)
    {
		...
		this.getQuoteDescriptor = this._buildParamsDescriptor([
            ...
            "detailFlag", false, this._validateAsOneOf(["FUNDAMENTAL","INTRADAY","OPTIONS","WEEK52","ALL"])
        ]);
    }
