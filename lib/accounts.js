...
exports.listAccounts = function()
{
    ...
    return this._run(actionDescriptor,{});
};
...
exports.getAccountPositions = function(params)
{
    //
    // From the etrade dev portal at
    ...
    {
        var isTypeCodeOption = function(p) { p.hasOwnProperty("typeCode") && p.typeCode == "OPT"; };
    ...
    if (validationResult.length)
        return Promise.reject(validationResult); // Validation failed
...
exports.getTransactionHistory = function(params)
{
    //
    // From the etrade dev portal at
    ...
    {
        var isGroupTrades = function(p) { p.hasOwnProperty("group") && params.group; };
        ...
        this.transactionHistoryDescriptors = this._buildParamsDescriptor([
           ...
           "count", false, this._validateAsInt.bind(this),
           "marker", false, this._validateAsInt.bind(this),
        ]);
    }
    ...
    if (params.hasOwnProperty("group"))
    {
        ...
        if (params.hasOwnProperty("assetType"))
        {
        ...
        if (params.hasOwnProperty("tickerSymbol"))
        {
...
exports.getTransactionDetails = function(params)
{
    //
    // From the etrade dev portal at
...
exports.getAlert = function(alertId)
{
    //
    // From the etrade dev portal at
